...
const Config = {
  ...
  trongrid: {
    host: 'https://api.nileex.io/', //https://api.trongrid.io
    key: ''
  },
  contract: {
  ...
  initCodeHash: '25ba9c789f8f74c1f3e6094d49b4a75a74aa6529d2a1ec61c5ef7ee4dc650ed8',
  sunUrl: 'https://sun.io/',
  sun: {
  ...
  swapApiPath: {
    ...
    defaultListSet: '/v2/defaultListSet', //默认token list
